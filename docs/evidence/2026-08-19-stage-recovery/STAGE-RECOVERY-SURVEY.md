...
| 영어 | EN loc | 대사집 | PS2 occ | 미해결 토큰 | confidence |
|---|---:|---|---:|---:|---|
...
## 4. the script reference — stage 텍스트에는 authority가 없다

지시 §8이 경고한 대로 가정하지 않고 실제로 검정했다.

- 완전 해독된 PS2 stage 58행을 대사집 4,091행과 대조 → **일치 0건.**
- 적 대사 4종의 한국어 후보도 대사집에는 없다 (컷신 문맥의 유사 어휘만 나온다).

**결론: 대사집은 movie/demo에는 유효했지만 stage에는 쓸 수 없다.**
