...
| 위치 | 화자 | 사유 |
|---|---|---|
| `913:29` | Zero | Zero가 제3자(Sokolov)의 말을 인용하는 절. 인용문 안쪽 말투를 화자 규칙으로 덮어쓸 수 없다 |
| `1537:10` | EVA | 어미 없는 종속절 조각(`...할 때까지...` 형태). 말투 표지가 없어 분류기 오탐이며 수정 불필요로 보이나 사람 판단이 필요하다 |
...
2. **HUMAN 2건** — `913:29`, `1537:10` 사용자 판단 대기.
