...
| DEC-014 | Korean reference ISO deletion is acceptable | all five extracted PS2 containers survive in `originals/ps2/`; movie/demo subtitles are hardsubbed so the ISO carried no unique extractable value beyond them | ACTIVE |
