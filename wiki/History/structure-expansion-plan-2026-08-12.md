...
The later 1,268-row scene-fixed/fixed-subtitle candidate also failed: the
opening demo played, then the first codec crashed. Although scene starts and
subtitle-relative layouts were fixed, 309 subtitle records grew by a combined
76,032 bytes and displaced later blocks inside their scenes. It was rolled
back. The stronger rule now requires every demo record's absolute offset and
size to remain unchanged as well; scene padding can no longer fund record
growth in a production candidate.
