> **보존본.** 루트 `HANDOFF.md`는 2026-08-22에 R12 형식(여섯 항목)으로 다시 썼다.
> 이 파일은 그 이전의 누적본이다 — 세션 층이 겹쳐 있고 서로 모순되는 대목이 있으며,
> 2026-08-12의 "do not retry" 지시는 명시적으로 무효다. 사실 확인은
> [`wiki/Current-State.md`](../Current-State.md)로 할 것. 지우지 않는 이유는 R8이다.
