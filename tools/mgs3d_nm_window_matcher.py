...
def main():
    ...
    def common(q):
        q.add_argument("--matches",type=Path,default=Path("experiments/story_media_order/story_sequence_dp_matches.csv"))
        q.add_argument("--review",type=Path,default=Path("experiments/story_media_order/story_sequence_dp_review.csv"))
        q.add_argument("--script-html",type=Path,default=Path("experiments/story_media_order/html/mgs3_manual_nm_alignment_review_v6.html"))
        q.add_argument("--manual",type=Path,default=Path("experiments/story_media_order/html/mgs3d_manual_alignment_review_v6.json"))
    q=sub.add_parser("inspect");common(q);q.set_defaults(fn=inspect)
    q=sub.add_parser("pilot");common(q);q.add_argument("--config",type=Path,default=Path("experiments/nm_window_matcher/config.json"));q.add_argument("--output",type=Path,default=Path("experiments/nm_window_matcher/output"));q.set_defaults(fn=run_pilot)
    q=sub.add_parser("evaluate");common(q);q.add_argument("--config",type=Path,default=Path("experiments/nm_window_matcher/config.json"));q.add_argument("--output",type=Path,default=Path("experiments/nm_window_matcher/output"));q.set_defaults(fn=run_pilot)
    q=sub.add_parser("blind");common(q);q.add_argument("--config",type=Path,default=Path("experiments/nm_window_matcher/config.json"));q.add_argument("--output",type=Path,default=Path("experiments/nm_window_matcher/output"));q.set_defaults(fn=run_pilot,blind=True)
    q=sub.add_parser("blind2");common(q);q.add_argument("--config",type=Path,default=Path("experiments/nm_window_matcher/config.json"));q.add_argument("--output",type=Path,default=Path("experiments/nm_window_matcher/output"));q.set_defaults(fn=run_pilot,blind2=True)
    q=sub.add_parser("assist");common(q);q.add_argument("--config",type=Path,default=Path("experiments/nm_window_matcher/config.json"));q.add_argument("--output",type=Path,default=Path("experiments/nm_window_matcher/output/manual_assist_candidates.json"));q.set_defaults(fn=generate_assist)
    q=sub.add_parser("assist-html");q.add_argument("--source-html",type=Path,default=Path("experiments/story_media_order/html/mgs3_manual_nm_alignment_review_v6_4_4_all_scenes_space_safe.html"));q.add_argument("--assist-json",type=Path,default=Path("experiments/nm_window_matcher/output/manual_assist_candidates.json"));q.add_argument("--output",type=Path,default=Path("experiments/story_media_order/html/mgs3_manual_nm_alignment_review_v6_5_assist.html"));q.set_defaults(fn=build_assist_html)
