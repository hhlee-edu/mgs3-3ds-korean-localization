...
def main() -> int:
    ...
    new36 = parse_codec(Path(
        "experiments/script_ref/full_build/rebuild_2026-08-08/codec_bisect8_test.dat"
    ).read_bytes())  # 36-shift, PASSED
    new37 = parse_codec(Path(
        "experiments/script_ref/full_build/rebuild_2026-08-08/codec_bisect9_test.dat"
    ...
    text = "\n".join(out)
    out_path = Path("experiments/script_ref/full_build/rebuild_2026-08-08/gcx53_boundary_table.txt")
